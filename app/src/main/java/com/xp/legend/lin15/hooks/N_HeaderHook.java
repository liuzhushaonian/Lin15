 ...
 * Android7.0的头部
 */
public class N_HeaderHook extends BaseHook implements IXposedHookLoadPackage {
...
//                myOrientationEventChangeListener.enable();
    ...
    private void registerReceiver() {
        ...
        if (this.receiver == null) {
            ...
            intentFilter.addAction(ReceiverAction.N_GET_EXPANSION_FLOAT);//传递下拉高度
    ...
    private class N_HeaderReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch (action) {
                ...
                case ReceiverAction.N_GET_EXPANSION_FLOAT://传递下拉程度
